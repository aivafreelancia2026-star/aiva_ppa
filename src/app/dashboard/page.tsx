    ...
    >
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2">
          <div className="glass-card p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/dashboard/tasks" className="text-xs text-purple-400 hover:text-purple-300 flex items-center gap-1">
            ...
            {loading ? (
              ...
              <div className="space-y-2">
                {todayTasks.map(task => {
                  ...
                  return (
                    <div key={task.id} className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors group">
                      <div className="w-4 h-4 rounded-full border-2 border-purple-500/50 flex-shrink-0 group-hover:border-purple-400" />
      ...
      <motion.div variants={itemVariants}>
        <div className="relative overflow-hidden rounded-2xl p-6"
          style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.2) 0%, rgba(79,70,229,0.1) 100%)', border: '1px solid rgba(139,92,246,0.25)' }}>
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-white">Talk to AIVA</h3>
