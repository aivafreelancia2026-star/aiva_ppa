-- ============================================================
-- AIVA PPA – Full Reset & Migrate
-- Run this entire script in the Supabase SQL Editor.
-- It drops everything cleanly before recreating, so it is
-- safe to run even when previous partial runs left stale objects.
-- ============================================================

-- ── 1. Drop tables in reverse-dependency order ───────────────
DROP TABLE IF EXISTS public.messages          CASCADE;
DROP TABLE IF EXISTS public.conversations     CASCADE;
DROP TABLE IF EXISTS public.counter_logs      CASCADE;
...
-- ── 2. Drop helper function if it already exists ────────────
